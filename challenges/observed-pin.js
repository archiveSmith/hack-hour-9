...
function getPINs(observed) {
  let baseArrs = constructArrs(observed.split(""));
  let output = [];

}

function constructArrs(observed) {
  let obj = { "1": [1, 2, 4], "2": [2, 1, 3, 5], "3": [3, 2, 6], "4": [4, 1, 5, 7], "5": [5, 2, 4, 6, 8], "6": [6, 3, 5, 9], "7": [4, 8], "8": [8, 5, 9, 0, 7], "9": [9, 8, 6], "0": [0, 8] }

  let possibles = []
  for (var i = 0; i < observed.length; i++) {
    possibles.push(obj[observed[i]])
  }

  return possibles
}

console.log(getPINs("135"));
